# Generated by Django 5.0.9 on 2024-10-27 21:29
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "regions",
                    models.ManyToManyField(
                        blank=True, related_name="+", to="dcim.region"
                    ),
                ),
                (
                    "roles",
                ...
                (
                    "site_groups",
                    models.ManyToManyField(
                        blank=True, related_name="+", to="dcim.sitegroup"
                    ),
                ),
                (
                    "sites",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(default="bootflash:", max_length=255),
                ),
                (
                    "device_upgrade_mode",
                    models.CharField(default="INSTALL_MODE", max_length=255),
                ),
                (
